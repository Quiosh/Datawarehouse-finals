...
def main():
    ...
    try:
        ...
        #  ADDED: Drop the old table to fix the "UndefinedColumn" error
        ...
        cur.execute("""
            CREATE TABLE dim_user (
                ...
                name            TEXT,
                creation_date   TIMESTAMP,  -- Changed to TIMESTAMP to match staging
                valid_from      TIMESTAMP,  -- Changed to TIMESTAMP for precision
                valid_to        TIMESTAMP,
                is_current      BOOLEAN DEFAULT TRUE,
                -- Add the demographic columns here so they aren't lost
                birthdate       DATE,
                gender          TEXT,
                user_type       TEXT,
                city            TEXT,
        ...
        # Create Index (This will now work because the column definitely exists)
        cur.execute("""
        ...
        # ==============================================================================
        # STEP 3: UPDATE JOB DETAILS (Merging Logic from old DIM_USER)
        # ==============================================================================
